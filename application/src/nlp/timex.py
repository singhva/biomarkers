...
reg6 = re.compile(regex3, re.IGNORECASE)
...
def demo():
    ...
    text = "Pemetrexed was administered at 500 mg/m(2) triweekly until progression with supplementations in chemo-naive ECOG PS 2 patients with EGFR wild-type or unknown advanced non-squamous NSCLC"
    print tag(text)
